...
exports.NetvisorEmployeeMethod = void 0;
var _method_1 = require("./_method");
var js2xmlparser = __importStar(require("js2xmlparser"));
var NetvisorEmployeeMethod = /** @class */ (function (_super) {
    __extends(NetvisorEmployeeMethod, _super);
    function NetvisorEmployeeMethod(client) {
        var _this = _super.call(this, client) || this;
        _this._endpointUri = 'employee.nv';
        return _this;
    }
    /**
     * Save employee data
     ...
     */
    NetvisorEmployeeMethod.prototype.saveEmployeeByDataSet = function (dataset, params) {
        return __awaiter(this, void 0, void 0, function () {
            var baseinformation, payrollinformation, organizedData, xml;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        baseinformation = !dataset.employee.employeebaseinformation.foreignemployeeidentification
                            ? {
                        ...
                        xml = js2xmlparser.parse('Root', organizedData);
     ...
     */
    NetvisorEmployeeMethod.prototype.getEmployeeSalaryParameters = function (employeeId, identifiertype) {
        if (identifiertype === void 0) { identifiertype = 'pin'; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.get('getemployeesalaryparameters.nv', { identifiertype: identifiertype, identifier: employeeId })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    return NetvisorEmployeeMethod;
}(_method_1.NetvisorMethod));
exports.NetvisorEmployeeMethod = NetvisorEmployeeMethod;
