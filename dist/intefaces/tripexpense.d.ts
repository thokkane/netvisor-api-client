...
type TravelType = 'car' | 'car_with_trailer' | 'car_with_caravan' | 'car_with_heavy_cargo' | 'car_with_big_machinery' | 'car_with_dog' | 'car_travel_in_rough_terrain' | 'motorboat_max_50hp' | 'motorboat_over_50hp' | 'snowmobile' | 'atv' | 'motorbike' | 'moped' | 'other' | 'carbenefit';
type Dimensions = {
